 ...
 *
 */
const nf=new RegExp("\0","g"),of=a.toEnum({Created:0,Unclassified:1,Ground:2,LowVegetation:3,MediumVegetation:4,HighVegetation:5,Building:6,LowPoint:7,ModelKeyPoint:8,Water:9,OverlapPoints:12});class af{constructor(e,t){if(this.m_bits=new Array,t&&t.length)for(let e=0;e<t.length;e++)this.m_bits.push(t[e]?af._ON:af._OFF);else isNaN(t)||(this.m_bits=af.shred(t).m_bits);if(e&&this.m_bits.length!==e)if(this.m_bits.length<e)for(let t=this.m_bits.length;t<e;t++)this.m_bits.push(af._OFF);else for(let t=e;t>this.m_bits.length;t--)this.m_bits.pop()}static _intersect(e,t){return e===af._ON&&t===af._ON?af._ON:af._OFF}static _union(e,t){return e===af._ON||t===af._ON?af._ON:af._OFF}static _difference(e,t){return e===af._ON&&t!==af._ON?af._ON:af._OFF}static _getLen(e,t,r){var n=e.getLength(),o=t.getLength();return r?o:n}static getUnion(e,t){for(var r=af._getLen(e,t,!0),n=new af(r),o=0;o<r;o++)n.setAt(o,af._union(e.getAt(o),t.getAt(o)));return n}static getIntersection(e,t){for(var r=af._getLen(e,t,!0),n=new af(r),o=0;o<r;o++)n.setAt(o,af._intersect(e.getAt(o),t.getAt(o)));return n}static getDifference(e,t){for(var r=af._getLen(e,t,!0),n=new af(r),o=0;o<r;o++)n.setAt(o,af._difference(e.getAt(o),t.getAt(o)));return n}static shred(e){var t=new Array,r=e;do{t.push(r%2),r=Math.floor(r/2)}while(r>0);return new af(t.length,t.reverse())}getLength(){return this.m_bits.length}getAt(e){return e<this.m_bits.length?this.m_bits[e]:null}setAt(e,t){e<this.m_bits.length&&(this.m_bits[e]=t?af._ON:af._OFF)}resize(e){for(var t=new Array,r=0;r<e;r++)r<this.m_bits.length?t.push(this.m_bits[r]):t.push(af._OFF);this.m_bits=t}getCompliment(){for(var e=new af(this.m_bits.length),t=0;t<this.m_bits.length;t++)e.setAt(t,this.m_bits[t]?af._OFF:af._ON);return e}toString(){for(var e=new String,t=0;t<this.m_bits.length;t++)e=e.concat(this.m_bits[t]===af._ON?"1":"0");return e}toNumber(){for(var e=0,t=0,r=this.m_bits.length-1;r>=0;r--)this.m_bits[r]===af._ON&&(t+=Math.pow(2,e)),e++;return t}}af._ON=1,af._OFF=0;class sf{static getBit(e,t){return e&1<<t?1:0}static setBit(e,t){return e|1<<t}static clearBit(e,t){return e&~(1<<t)}static updateBit(e,t,r){return e&~(1<<t)|(r?1:0)<<t}static getBits(e,t){let r=0;for(let n of t)sf.getBit(e,n)&&(r=sf.setBit(r,n));return r}}exports.ASCLoader=
/**
