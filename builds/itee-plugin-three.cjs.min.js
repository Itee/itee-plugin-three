 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Object3D:$}=N;let V,U;function R(e){return V||function(e){const t=e.Schema;V=new t({})}(e),V}function k(e){const t=$.getModelFrom(e);U=t.discriminator("PositionalAudio",R(e))}var H={name:"PositionalAudio",getSchemaFrom:R,getModelFrom:function(e){return U||k(e),U},registerModelTo:function(e){return U||k(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Object3D:ne}=N;let oe,ie;function ae(e){return oe||function(e){const t=e.Schema;oe=new t({})}(e),oe}function ce(e){const t=ne.getModelFrom(e);ie=t.discriminator("CubeCamera",ae(e))}var se={name:"CubeCamera",getSchemaFrom:ae,getModelFrom:function(e){return ie||ce(e),ie},registerModelTo:function(e){return ie||ce(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */let Ee,Ge;function Le(e){return Ee||function(e){const t=e.Schema,r=t.Types,n=r.Mixed,o=r.Vector3,i=Ae.getSchemaFrom(e);Ee=new t({uuid:String,name:String,type:String,index:i,attributes:{position:i,normal:i,color:i,uv:i},groups:n,boundingBox:{min:o,max:o},boundingSphere:{center:o,radius:Number},drawRange:n},{collection:"geometries",discriminatorKey:"type"})}(e),Ee}function Pe(e){Ge=e.model("BufferGeometries",Le(e)),Ge.discriminator("BufferGeometry",new e.Schema({}))}const je={getSchemaFrom:Le,getModelFrom:function(e){return Ge||Pe(e),Ge},registerModelTo:function(e){return Ge||Pe(e),e}};var $e=Object.freeze({__proto__:null,BufferGeometry:je});
/**
 * @module Schemas/Curves/Curve
 * @desc Export the ThreeJs Curve Model and Schema for Mongoose.
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */let Ve,Ue;function Re(e){return Ve||function(e){const t=e.Schema;Ve=new t({type:{type:String,default:"Curve"},arcLengthDivisions:Number},{collection:"curves",discriminatorKey:"type"})}(e),Ve}function ke(e){Ue=e.model("Curves",Re(e)),Ue.discriminator("Curve",new e.Schema({}))}var He={name:"Curve",getSchemaFrom:Re,getModelFrom:function(e){return Ue||ke(e),Ue},registerModelTo:function(e){return Ue||ke(e),e}},ze={Curve:He};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Curve:at}=ze;let ct,st;function ut(e){return ct||function(e){const t=e.Schema,r=t.Types.Vector2,n=new t({type:{type:String,default:"Curve"},arcLengthDivisions:Number},{id:!1,_id:!1});ct=new t({curves:[n],autoClose:{type:Boolean,default:!1},currentPoint:r})}(e),ct}function mt(e){const t=at.getModelFrom(e);st=t.discriminator("Path",ut(e))}var dt={name:"Path",getSchemaFrom:ut,getModelFrom:function(e){return st||mt(e),st},registerModelTo:function(e){return st||mt(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Curve:Lt}=ze;let Pt,jt;function $t(e){return Pt||function(e){const t=e.Schema,r=t.Types.Vector3;Pt=new t({v0:r,v1:r,v2:r,v3:r})}(e),Pt}function Vt(e){const t=Lt.getModelFrom(e);jt=t.discriminator("CubicBezierCurve3",$t(e))}var Ut={name:"CubicBezierCurve3",getSchemaFrom:$t,getModelFrom:function(e){return jt||Vt(e),jt},registerModelTo:function(e){return jt||Vt(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Curve:er}=ze;let tr,rr;function nr(e){return tr||function(e){const t=e.Schema,r=t.Types.Vector2;tr=new t({v0:r,v1:r})}(e),tr}function or(e){const t=er.getModelFrom(e);rr=t.discriminator("LineCurve",nr(e))}var ir={name:"LineCurve",getSchemaFrom:nr,getModelFrom:function(e){return rr||or(e),rr},registerModelTo:function(e){return rr||or(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Curve:ar}=ze;let cr,sr;function ur(e){return cr||function(e){const t=e.Schema,r=t.Types.Vector3;cr=new t({v0:r,v1:r})}(e),cr}function mr(e){const t=ar.getModelFrom(e);sr=t.discriminator("LineCurve3",ur(e))}var dr={name:"LineCurve3",getSchemaFrom:ur,getModelFrom:function(e){return sr||mr(e),sr},registerModelTo:function(e){return sr||mr(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Curve:Lr}=ze;let Pr,jr;function $r(e){return Pr||function(e){const t=e.Schema,r=t.Types.Vector3;Pr=new t({points:[r]})}(e),Pr}function Vr(e){const t=Lr.getModelFrom(e);jr=t.discriminator("SplineCurve",$r(e))}var Ur={name:"SplineCurve",getSchemaFrom:$r,getModelFrom:function(e){return jr||Vr(e),jr},registerModelTo:function(e){return jr||Vr(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:Wr}=it;let Xr,Zr;function Jr(e){return Xr||function(e){const t=e.Schema;Xr=new t({})}(e),Xr}function qr(e){const t=Wr.getModelFrom(e);Zr=t.discriminator("BoxGeometry",Jr(e))}var Kr={name:"BoxGeometry",getSchemaFrom:Jr,getModelFrom:function(e){return Zr||qr(e),Zr},registerModelTo:function(e){return Zr||qr(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:cn}=it;let sn,un;function mn(e){return sn||function(e){const t=e.Schema;sn=new t({})}(e),sn}function dn(e){const t=cn.getModelFrom(e);un=t.discriminator("CircleGeometry",mn(e))}var ln={name:"CircleGeometry",getSchemaFrom:mn,getModelFrom:function(e){return un||dn(e),un},registerModelTo:function(e){return un||dn(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{BufferGeometry:fn}=$e;let hn,gn;function pn(e){return hn||function(e){const t=e.Schema;hn=new t({})}(e),hn}function Sn(e){const t=fn.getModelFrom(e);gn=t.discriminator("ConeBufferGeometry",pn(e))}var yn={name:"ConeBufferGeometry",getSchemaFrom:pn,getModelFrom:function(e){return gn||Sn(e),gn},registerModelTo:function(e){return gn||Sn(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:Mn}=it;let bn,Tn;function Fn(e){return bn||function(e){const t=e.Schema;bn=new t({})}(e),bn}function wn(e){const t=Mn.getModelFrom(e);Tn=t.discriminator("ConeGeometry",Fn(e))}var vn={name:"ConeGeometry",getSchemaFrom:Fn,getModelFrom:function(e){return Tn||wn(e),Tn},registerModelTo:function(e){return Tn||wn(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:Pn}=it;let jn,$n;function Vn(e){return jn||function(e){const t=e.Schema;jn=new t({})}(e),jn}function Un(e){const t=Pn.getModelFrom(e);$n=t.discriminator("CylinderGeometry",Vn(e))}var Rn={name:"CylinderGeometry",getSchemaFrom:Vn,getModelFrom:function(e){return $n||Un(e),$n},registerModelTo:function(e){return $n||Un(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:kn}=it;let Hn,zn;function Yn(e){return Hn||function(e){const t=e.Schema;Hn=new t({})}(e),Hn}function Qn(e){const t=kn.getModelFrom(e);zn=t.discriminator("DecalGeometry",Yn(e))}var Wn={name:"DecalGeometry",getSchemaFrom:Yn,getModelFrom:function(e){return zn||Qn(e),zn},registerModelTo:function(e){return zn||Qn(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:Xn}=it;let Zn,Jn;function qn(e){return Zn||function(e){const t=e.Schema;Zn=new t({})}(e),Zn}function Kn(e){const t=Xn.getModelFrom(e);Jn=t.discriminator("DodecahedronGeometry",qn(e))}var eo={name:"DodecahedronGeometry",getSchemaFrom:qn,getModelFrom:function(e){return Jn||Kn(e),Jn},registerModelTo:function(e){return Jn||Kn(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:to}=it;let ro,no;function oo(e){return ro||function(e){const t=e.Schema;ro=new t({})}(e),ro}function io(e){const t=to.getModelFrom(e);no=t.discriminator("EdgesGeometry",oo(e))}var ao={name:"EdgesGeometry",getSchemaFrom:oo,getModelFrom:function(e){return no||io(e),no},registerModelTo:function(e){return no||io(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{BufferGeometry:co}=$e;let so,uo;function mo(e){return so||function(e){const t=e.Schema;so=new t({})}(e),so}function lo(e){const t=co.getModelFrom(e);uo=t.discriminator("ExtrudeBufferGeometry",mo(e))}var fo={name:"ExtrudeBufferGeometry",getSchemaFrom:mo,getModelFrom:function(e){return uo||lo(e),uo},registerModelTo:function(e){return uo||lo(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{BufferGeometry:bo}=$e;let To,Fo;function wo(e){return To||function(e){const t=e.Schema;To=new t({})}(e),To}function vo(e){const t=bo.getModelFrom(e);Fo=t.discriminator("IcosahedronBufferGeometry",wo(e))}var _o={name:"IcosahedronBufferGeometry",getSchemaFrom:wo,getModelFrom:function(e){return Fo||vo(e),Fo},registerModelTo:function(e){return Fo||vo(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{BufferGeometry:jo}=$e;let $o,Vo;function Uo(e){return $o||function(e){const t=e.Schema;$o=new t({})}(e),$o}function Ro(e){const t=jo.getModelFrom(e);Vo=t.discriminator("LatheBufferGeometry",Uo(e))}var ko={name:"LatheBufferGeometry",getSchemaFrom:Uo,getModelFrom:function(e){return Vo||Ro(e),Vo},registerModelTo:function(e){return Vo||Ro(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:Ho}=it;let zo,Yo;function Qo(e){return zo||function(e){const t=e.Schema;zo=new t({})}(e),zo}function Wo(e){const t=Ho.getModelFrom(e);Yo=t.discriminator("LatheGeometry",Qo(e))}var Xo={name:"LatheGeometry",getSchemaFrom:Qo,getModelFrom:function(e){return Yo||Wo(e),Yo},registerModelTo:function(e){return Yo||Wo(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{BufferGeometry:Zo}=$e;let Jo,qo;function Ko(e){return Jo||function(e){const t=e.Schema;Jo=new t({})}(e),Jo}function ei(e){const t=Zo.getModelFrom(e);qo=t.discriminator("OctahedronBufferGeometry",Ko(e))}var ti={name:"OctahedronBufferGeometry",getSchemaFrom:Ko,getModelFrom:function(e){return qo||ei(e),qo},registerModelTo:function(e){return qo||ei(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:ri}=it;let ni,oi;function ii(e){return ni||function(e){const t=e.Schema;ni=new t({})}(e),ni}function ai(e){const t=ri.getModelFrom(e);oi=t.discriminator("OctahedronGeometry",ii(e))}var ci={name:"OctahedronGeometry",getSchemaFrom:ii,getModelFrom:function(e){return oi||ai(e),oi},registerModelTo:function(e){return oi||ai(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{BufferGeometry:si}=$e;let ui,mi;function di(e){return ui||function(e){const t=e.Schema;ui=new t({})}(e),ui}function li(e){const t=si.getModelFrom(e);mi=t.discriminator("ParametricBufferGeometry",di(e))}var fi={name:"ParametricBufferGeometry",getSchemaFrom:di,getModelFrom:function(e){return mi||li(e),mi},registerModelTo:function(e){return mi||li(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:hi}=it;let gi,pi;function Si(e){return gi||function(e){const t=e.Schema;gi=new t({})}(e),gi}function yi(e){const t=hi.getModelFrom(e);pi=t.discriminator("ParametricGeometry",Si(e))}var Mi={name:"ParametricGeometry",getSchemaFrom:Si,getModelFrom:function(e){return pi||yi(e),pi},registerModelTo:function(e){return pi||yi(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{BufferGeometry:bi}=$e;let Ti,Fi;function wi(e){return Ti||function(e){const t=e.Schema;Ti=new t({})}(e),Ti}function vi(e){const t=bi.getModelFrom(e);Fi=t.discriminator("PlaneBufferGeometry",wi(e))}var _i={name:"PlaneBufferGeometry",getSchemaFrom:wi,getModelFrom:function(e){return Fi||vi(e),Fi},registerModelTo:function(e){return Fi||vi(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:Ni}=it;let Bi,Ci;function Oi(e){return Bi||function(e){const t=e.Schema;Bi=new t({})}(e),Bi}function Di(e){const t=Ni.getModelFrom(e);Ci=t.discriminator("PlaneGeometry",Oi(e))}var xi={name:"PlaneGeometry",getSchemaFrom:Oi,getModelFrom:function(e){return Ci||Di(e),Ci},registerModelTo:function(e){return Ci||Di(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{BufferGeometry:Ii}=$e;let Ai,Ei;function Gi(e){return Ai||function(e){const t=e.Schema;Ai=new t({})}(e),Ai}function Li(e){const t=Ii.getModelFrom(e);Ei=t.discriminator("PolyhedronBufferGeometry",Gi(e))}var Pi={name:"PolyhedronBufferGeometry",getSchemaFrom:Gi,getModelFrom:function(e){return Ei||Li(e),Ei},registerModelTo:function(e){return Ei||Li(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:ji}=it;let $i,Vi;function Ui(e){return $i||function(e){const t=e.Schema;$i=new t({})}(e),$i}function Ri(e){const t=ji.getModelFrom(e);Vi=t.discriminator("PolyhedronGeometry",Ui(e))}var ki={name:"PolyhedronGeometry",getSchemaFrom:Ui,getModelFrom:function(e){return Vi||Ri(e),Vi},registerModelTo:function(e){return Vi||Ri(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{BufferGeometry:Hi}=$e;let zi,Yi;function Qi(e){return zi||function(e){const t=e.Schema;zi=new t({})}(e),zi}function Wi(e){const t=Hi.getModelFrom(e);Yi=t.discriminator("RingBufferGeometry",Qi(e))}var Xi={name:"RingBufferGeometry",getSchemaFrom:Qi,getModelFrom:function(e){return Yi||Wi(e),Yi},registerModelTo:function(e){return Yi||Wi(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:sa}=it;let ua,ma;function da(e){return ua||function(e){const t=e.Schema;ua=new t({})}(e),ua}function la(e){const t=sa.getModelFrom(e);ma=t.discriminator("ShapeGeometry",da(e))}var fa={name:"ShapeGeometry",getSchemaFrom:da,getModelFrom:function(e){return ma||la(e),ma},registerModelTo:function(e){return ma||la(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{BufferGeometry:ha}=$e;let ga,pa;function Sa(e){return ga||function(e){const t=e.Schema;ga=new t({})}(e),ga}function ya(e){const t=ha.getModelFrom(e);pa=t.discriminator("SphereBufferGeometry",Sa(e))}var Ma={name:"SphereBufferGeometry",getSchemaFrom:Sa,getModelFrom:function(e){return pa||ya(e),pa},registerModelTo:function(e){return pa||ya(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:ba}=it;let Ta,Fa;function wa(e){return Ta||function(e){const t=e.Schema;Ta=new t({})}(e),Ta}function va(e){const t=ba.getModelFrom(e);Fa=t.discriminator("SphereGeometry",wa(e))}var _a={name:"SphereGeometry",getSchemaFrom:wa,getModelFrom:function(e){return Fa||va(e),Fa},registerModelTo:function(e){return Fa||va(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{BufferGeometry:Na}=$e;let Ba,Ca;function Oa(e){return Ba||function(e){const t=e.Schema;Ba=new t({})}(e),Ba}function Da(e){const t=Na.getModelFrom(e);Ca=t.discriminator("TeapotBufferGeometry",Oa(e))}var xa={name:"TeapotBufferGeometry",getSchemaFrom:Oa,getModelFrom:function(e){return Ca||Da(e),Ca},registerModelTo:function(e){return Ca||Da(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{BufferGeometry:Ia}=$e;let Aa,Ea;function Ga(e){return Aa||function(e){const t=e.Schema;Aa=new t({})}(e),Aa}function La(e){const t=Ia.getModelFrom(e);Ea=t.discriminator("TetrahedronBufferGeometry",Ga(e))}var Pa={name:"TetrahedronBufferGeometry",getSchemaFrom:Ga,getModelFrom:function(e){return Ea||La(e),Ea},registerModelTo:function(e){return Ea||La(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:ja}=it;let $a,Va;function Ua(e){return $a||function(e){const t=e.Schema;$a=new t({})}(e),$a}function Ra(e){const t=ja.getModelFrom(e);Va=t.discriminator("TetrahedronGeometry",Ua(e))}var ka={name:"TetrahedronGeometry",getSchemaFrom:Ua,getModelFrom:function(e){return Va||Ra(e),Va},registerModelTo:function(e){return Va||Ra(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:Za}=it;let Ja,qa;function Ka(e){return Ja||function(e){const t=e.Schema;Ja=new t({})}(e),Ja}function ec(e){const t=Za.getModelFrom(e);qa=t.discriminator("TextGeometry",Ka(e))}var tc={name:"TextGeometry",getSchemaFrom:Ka,getModelFrom:function(e){return qa||ec(e),qa},registerModelTo:function(e){return qa||ec(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{BufferGeometry:rc}=$e;let nc,oc;function ic(e){return nc||function(e){const t=e.Schema;nc=new t({})}(e),nc}function ac(e){const t=rc.getModelFrom(e);oc=t.discriminator("TorusBufferGeometry",ic(e))}var cc={name:"TorusBufferGeometry",getSchemaFrom:ic,getModelFrom:function(e){return oc||ac(e),oc},registerModelTo:function(e){return oc||ac(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:sc}=it;let uc,mc;function dc(e){return uc||function(e){const t=e.Schema;uc=new t({})}(e),uc}function lc(e){const t=sc.getModelFrom(e);mc=t.discriminator("TorusGeometry",dc(e))}var fc={name:"TorusGeometry",getSchemaFrom:dc,getModelFrom:function(e){return mc||lc(e),mc},registerModelTo:function(e){return mc||lc(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{BufferGeometry:hc}=$e;let gc,pc;function Sc(e){return gc||function(e){const t=e.Schema;gc=new t({})}(e),gc}function yc(e){const t=hc.getModelFrom(e);pc=t.discriminator("TorusKnotBufferGeometry",Sc(e))}var Mc={name:"TorusKnotBufferGeometry",getSchemaFrom:Sc,getModelFrom:function(e){return pc||yc(e),pc},registerModelTo:function(e){return pc||yc(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:bc}=it;let Tc,Fc;function wc(e){return Tc||function(e){const t=e.Schema;Tc=new t({})}(e),Tc}function vc(e){const t=bc.getModelFrom(e);Fc=t.discriminator("TorusKnotGeometry",wc(e))}var _c={name:"TorusKnotGeometry",getSchemaFrom:wc,getModelFrom:function(e){return Fc||vc(e),Fc},registerModelTo:function(e){return Fc||vc(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Geometry:jc}=it;let $c,Vc;function Uc(e){return $c||function(e){const t=e.Schema;$c=new t({})}(e),$c}function Rc(e){const t=jc.getModelFrom(e);Vc=t.discriminator("WireframeGeometry",Uc(e))}var kc={name:"WireframeGeometry",getSchemaFrom:Uc,getModelFrom:function(e){return Vc||Rc(e),Vc},registerModelTo:function(e){return Vc||Rc(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Object3D:rs}=N;let ns,os;function is(e){return ns||function(e){const t=e.Schema;ns=new t({})}(e),ns}function as(e){const t=rs.getModelFrom(e);os=t.discriminator("Box3Helper",is(e))}var cs={name:"Box3Helper",getSchemaFrom:is,getModelFrom:function(e){return os||as(e),os},registerModelTo:function(e){return os||as(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Object3D:js}=N;let $s,Vs;function Us(e){return $s||function(e){const t=e.Schema;$s=new t({})}(e),$s}function Rs(e){const t=js.getModelFrom(e);Vs=t.discriminator("HemisphereLightHelper",Us(e))}var ks={name:"HemisphereLightHelper",getSchemaFrom:Us,getModelFrom:function(e){return Vs||Rs(e),Vs},registerModelTo:function(e){return Vs||Rs(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Object3D:ru}=N;let nu,ou;function iu(e){return nu||function(e){const t=e.Schema;nu=new t({})}(e),nu}function au(e){const t=ru.getModelFrom(e);ou=t.discriminator("PolarGridHelper",iu(e))}var cu={name:"PolarGridHelper",getSchemaFrom:iu,getModelFrom:function(e){return ou||au(e),ou},registerModelTo:function(e){return ou||au(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Object3D:ju}=N;let $u,Vu;function Uu(e){return $u||function(e){const t=e.Schema;$u=new t({})}(e),$u}function Ru(e){const t=ju.getModelFrom(e);Vu=t.discriminator("DirectionalLight",Uu(e))}var ku={name:"DirectionalLight",getSchemaFrom:Uu,getModelFrom:function(e){return Vu||Ru(e),Vu},registerModelTo:function(e){return Vu||Ru(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Object3D:rm}=N;let nm,om;function im(e){return nm||function(e){const t=e.Schema;nm=new t({})}(e),nm}function am(e){const t=rm.getModelFrom(e);om=t.discriminator("PointLight",im(e))}var cm={name:"PointLight",getSchemaFrom:im,getModelFrom:function(e){return om||am(e),om},registerModelTo:function(e){return om||am(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Material:jm}=_m;let $m,Vm;function Um(e){return $m||function(e){const t=e.Schema,r=t.Types,n=r.Mixed,o=r.Color;$m=new t({color:o,map:n,lightMap:n,lightMapIntensity:Number,aoMap:n,aoMapIntensity:Number,specularMap:n,alphaMap:n,envMap:n,combine:Number,reflectivity:Number,refractionRatio:Number,wireframe:Boolean,wireframeLinewidth:Number,wireframeLinecap:String,wireframeLinejoin:String,skinning:Boolean,morphTargets:Boolean,light:Boolean})}(e),$m}function Rm(e){const t=jm.getModelFrom(e);Vm=t.discriminator("MeshBasicMaterial",Um(e))}var km={name:"MeshBasicMaterial",getSchemaFrom:Um,getModelFrom:function(e){return Vm||Rm(e),Vm},registerModelTo:function(e){return Vm||Rm(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Material:rd}=_m;let nd,od;function id(e){return nd||function(e){const t=e.Schema,r=t.Types,n=r.Mixed,o=r.Vector2;nd=new t({bumpMap:n,bumpScale:Number,normalMap:n,normalScale:o,displacementMap:n,displacementScale:Number,displacementBias:Number,wireframe:Boolean,wireframeLinewidth:Number,fog:Boolean,light:Boolean,skinning:Boolean,morphTargets:Boolean,morphNormals:Boolean})}(e),nd}function ad(e){const t=rd.getModelFrom(e);od=t.discriminator("MeshNormalMaterial",id(e))}var cd={name:"MeshNormalMaterial",getSchemaFrom:id,getModelFrom:function(e){return od||ad(e),od},registerModelTo:function(e){return od||ad(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Material:jd}=_m;let $d,Vd;function Ud(e){return $d||function(e){const t=e.Schema,r=t.Types.Mixed;$d=new t({defines:r,uniforms:r,vertexShader:String,fragmentShader:String,linewidth:Number,wireframe:Boolean,wireframeLinewidth:Number,fog:Boolean,light:Boolean,clipping:Boolean,skinning:Boolean,morphTargets:Boolean,morphNormals:Boolean,derivatives:Boolean,fragDepth:Boolean,drawBuffers:Boolean,shaderTextureLOD:Boolean})}(e),$d}function Rd(e){const t=jd.getModelFrom(e);Vd=t.discriminator("RawShaderMaterial",Ud(e))}var kd={name:"RawShaderMaterial",getSchemaFrom:Ud,getModelFrom:function(e){return Vd||Rd(e),Vd},registerModelTo:function(e){return Vd||Rd(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Material:rl}=_m;let nl,ol;function il(e){return nl||function(e){const t=e.Schema,r=t.Types,n=r.Color,o=r.Mixed;nl=new t({color:n,map:o,rotation:Number,fog:Boolean,lights:Boolean})}(e),nl}function al(e){const t=rl.getModelFrom(e);ol=t.discriminator("SpriteMaterial",il(e))}var cl={name:"SpriteMaterial",getSchemaFrom:il,getModelFrom:function(e){return ol||al(e),ol},registerModelTo:function(e){return ol||al(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */let Ll,Pl;function jl(e){return Ll||function(e){const t=e.Schema;Ll=new t({})}(e),Ll}function $l(e){const t=Gl.getModelFrom(e);Pl=t.discriminator("ImmediateRenderObject",jl(e))}var Vl={name:"ImmediateRenderObject",getSchemaFrom:jl,getModelFrom:function(e){return Pl||$l(e),Pl},registerModelTo:function(e){return Pl||$l(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Object3D:Lf}=N;let Pf,jf;function $f(e){return Pf||function(e){const t=e.Schema,r=t.Types.ObjectId;Pf=new t({geometry:{type:r,ref:"Geometry"},material:[{type:r,ref:"Material"}],drawMode:Number,bindMode:String,bindMatrix:[Number],bindMatrixInverse:[Number]})}(e),Pf}function Vf(e){const t=Lf.getModelFrom(e);jf=t.discriminator("SkinnedMesh",$f(e))}var Uf={name:"SkinnedMesh",getSchemaFrom:$f,getModelFrom:function(e){return jf||Vf(e),jf},registerModelTo:function(e){return jf||Vf(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Texture:Eh}=uh;let Gh,Lh;function Ph(e){return Gh||function(e){const t=e.Schema;Gh=new t({})}(e),Gh}function jh(e){const t=Eh.getModelFrom(e);Lh=t.discriminator("DepthTexture",Ph(e))}var $h={name:"DepthTexture",getSchemaFrom:Ph,getModelFrom:function(e){return Lh||jh(e),Lh},registerModelTo:function(e){return Lh||jh(e),e}};
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const{Texture:Vh}=uh;let Uh,Rh;function kh(e){return Uh||function(e){const t=e.Schema;Uh=new t({})}(e),Uh}function Hh(e){const t=Vh.getModelFrom(e);Rh=t.discriminator("VideoTexture",kh(e))}var zh={name:"VideoTexture",getSchemaFrom:kh,getModelFrom:function(e){return Rh||Hh(e),Rh},registerModelTo:function(e){return Rh||Hh(e),e}};
/**
 * @module Types/Color
